...
public class OrganizationsEventParser {

    private AdminEvent event;
    private KeycloakSession session;

    public static final String EVT_RESOURCE_USERS = "users";
    public static final String EVT_RESOURCE_GROUPS = "organization";
    public static final String EVT_RESOURCE_ROLES_BY_ID = "roles-by-id";
    public static final String OBJECT_TYPE_USER = "user";
    public static final String OBJECT_TYPE_ROLE = "organization";

    private static final Logger LOG = Logger.getLogger(EventParser.class);

    public OrganizationsEventParser(AdminEvent event) {
        this.event = event;
    }

    public OrganizationsEventParser(AdminEvent event, KeycloakSession session) {
        this.event = event;
    ...
    public String findClientIdWithOrgsName(String organizatioName) {
        ClientModel client = session.getContext().getRealm().getClientByClientId(organizatioName);
